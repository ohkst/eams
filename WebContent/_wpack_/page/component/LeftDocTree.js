/*amd /page/component/LeftDocTree.xml 6034 77e8f2b5a6e2252ab08c4e59a931c6915dac2596bfdc5e35a4b139ecad2509a6 */
...
}}}]}]},{T:1,N:'body',A:{'ev:onpageload':'scwin.onpageload',style:';max-width:100%;min-width:100%;'},E:[{T:1,N:'xf:group',A:{style:'width:100%;height: 100vh;background-color:#EFF0F4;padding: 12px;display: flex;flex-direction: column;overflow-y: auto;scrollbar-width: none;gap: 12px;box-sizing: border-box;',id:''},E:[{T:1,N:'w2:button',A:{'ev:onclick':'scwin.btnNetwork_onclick',id:'btnBA',label:'BA',style:'width: 100%;height: 48px;font-size:18px;font-weight:bold;text-align:left;border-width:0px;'}},{T:1,N:'w2:button',A:{'ev:onclick':'scwin.btnDB_onclick',id:'btnAA',label:'AA',style:'width: 100%;height: 48px;font-size:18px;font-weight:bold;text-align:left;border-width:0px;'}},{T:1,N:'w2:button',A:{'ev:onclick':'scwin.btnServer_onclick',id:'btnDA',label:'DA',style:'width:100%;height:48px;font-size:18px;font-weight:bold;text-align:left;border-width:0px;'}},{T:1,N:'w2:button',A:{'ev:onclick':'scwin.btnServer_onclick',id:'btnTA',label:'TA',style:'width:100%;height:48px;font-size:18px;font-weight:bold;text-align:left;border-width:0px;'}}]}]}]}]})