/*amd /cm/gcc/util.xml 31769 04b824e9ac2ce6de4d97ce08b04092d1fa257d4e3f9f85d5c896075542803962 */
...
scwin.isEmpty = function ($p, value) {
  ...
  if (WebSquare.util.isArray(value) && value.length == 0) return true;
  if (value == "{}") return true;
 ...
 * @example ${example}
 */
scwin.openEamsPopup = function ($p, path, title, object) {
